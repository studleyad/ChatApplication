...
var routes = [
    ...
    { path: 'profile', loadChildren: './profile/profile.module#ProfilePageModule', canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
    { path: 'settings', loadChildren: './settings/settings.module#SettingsPageModule', canActivate: [_core_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] }
];
...
/* harmony import */ var _login_services_auth_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./login/services/auth.service */ "./src/app/login/services/auth.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"],
                _angular_fire__WEBPACK_IMPORTED_MODULE_6__["AngularFireModule"].initializeApp(firebaseAuth),
            ...
            providers: [
                ...
                _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["Nav"],
                _login_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"],
                _core_auth_guard__WEBPACK_IMPORTED_MODULE_11__["AuthGuard"]
            ],
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        var _this = this;
        return this.auth.isSignedInStream.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (isSignedIn) {
            if (!isSignedIn) {
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_login_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var AuthService = /** @class */ (function () {
    function AuthService(router, afAuth) {
        ...
        this.isSignedInStream = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (user) {
            return user != null;
        }));
    }
...
module.exports = __webpack_require__(/*! /Users/drew/Desktop/Apps/Field/login/src/main.ts */"./src/main.ts");
